    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hidden', models.ManyToManyField(default=None, related_name='hidden_contributions', to='empo_news.Contribution')),
                ('upvoted', models.ManyToManyField(default=None, related_name='upvoted_contributions', to='empo_news.Contribution')),
